<template>
    <admin-template :current_user="current_user">
        ...
        <div class="bg-white rounded-lg min-h-full ">
            <div class="flex flex-col gap-2 md:flex-row md:gap-8 py-8 px-10 bg-slate-100 rounded-t-lg">
                <div class="shrink">
                ...
                <div class="shrink">
                    <b class="md:block pr-4 text-slate-600 text-sm">Player ID <span class="text-slate-400 whitespace-nowrap">(Steam ID)</span>:</b>
            ...
            <div id="notes" class="py-10 px-10">
                <h2 class="text-2xl text-slate-700 font-medium font-exo">
                    User Notes
                </h2>
                <p class="block text-sm text-slate-500">User notes are used to show a timeline of updates about an applicant or member.</p>

                <div id="writing_area" class="py-4 flex flex-col gap-4">
                    <textarea class="h-24 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md placeholder-slate-400" :placeholder="'Information about the user ' + user.username"></textarea>
                    <div class="flex">
                        <div class="grow"></div>
                        <div class="shrink">

                            <button class="inline-block px-4 py-2 bg-indigo-500 text-white rounded-lg text-sm font-semibold hover:bg-indigo-700 transition-colors">Commit new User Note</button>
                        </div>
                    </div>
                </div>
                <div id="timeline" class="w-full text-center py-10 text-sm text-slate-400">
