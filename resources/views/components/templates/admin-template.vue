...
<!--                                <img class="h-8 w-8" src="https://australianarmedforces.org/admin/images/logo_2x.png" alt="Scarlet Logo">-->
                        ...
                        <div class="ml-10 flex items-baseline space-x-4">
                            <Link :href="$route('admin.user.index')" :class="{ 'bg-black/70 hover:bg-black/60 ': $route().current('admin.user.*') }" class="transition-colors text-white px-4 py-2 rounded-md text-sm font-medium" aria-current="page">
                                User Management
                            </Link>
